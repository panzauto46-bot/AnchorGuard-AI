...
export function UserMenu() {
  ...
  return (
    <div ref={menuRef} className="relative">
      ...
      >
        {/* Avatar */}
        <div className={`relative w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-bold ${
      ...
      {open && (
        <div
          className={`absolute right-0 top-full mt-2 w-64 rounded-2xl border overflow-hidden ${
            isDark
        ...
        >
          ...
          <div className="py-1.5">
            <button className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-all ${
              isDark ? 'text-zinc-300 hover:bg-white/5' : 'text-zinc-700 hover:bg-zinc-50'
            }`}>
          ...
          <div className={`border-t py-1.5 ${isDark ? 'border-dark-border' : 'border-light-border'}`}>
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-all ${
                isDark ? 'text-red-400 hover:bg-red-500/5' : 'text-red-600 hover:bg-red-50'
              }`}
            >
