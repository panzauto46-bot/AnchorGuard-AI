...
function LoginOption({ provider, icon, title, subtitle, accentColor, hoverBg, borderColor, isLoading, loadingProvider, onLogin }: LoginOptionProps) {
  ...
  return (
    ...
    >
      {/* Icon */}
      <div className={`relative w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-all ${
        isThisLoading ? hoverBg : isDark ? 'bg-white/5' : 'bg-zinc-100'
      }`}>
        {isThisLoading ? (
      ...
      <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none ${
        provider === 'google' ? 'shadow-[inset_0_0_30px_rgba(66,133,244,0.05)]' :
      ...
      >
        ...
        <div className="relative px-6 pt-6 pb-2">
          ...
          <div className={`flex items-center gap-2 px-3 py-2 rounded-xl mb-6 ${
            isDark ? 'bg-solana-green/5 border border-solana-green/10' : 'bg-green-50 border border-green-100'
          }`}>
        ...
        <div className="relative px-6 space-y-3">
          ...
          <LoginOption
            ...
            accentColor="text-solana-purple"
            hoverBg="bg-solana-purple/5"
