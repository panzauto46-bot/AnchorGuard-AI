...
export function exportToMarkdown(result: AuditResult): string {
    ...
    md += `| 🟢 Safe Patterns | ${summary.safe} |\n`;
    md += `| ⚡ Compute Optimizations | ${summary.computeOptimizations} |\n\n`;
    ...
    md += `---\n\n`;
    md += `*Report generated by [AnchorGuard AI](https://anchor-guard-ai.vercel.app) — The AI-Powered Reasoning Auditor for Solana Smart Contracts*\n`;
...
export function downloadPDF(result: AuditResult) {
    ...
    doc.text('Report generated by AnchorGuard AI — The AI-Powered Reasoning Auditor for Solana Smart Contracts', margin, y);
